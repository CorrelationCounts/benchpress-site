...
import RunBenchpressCard from "@/components/RunBenchpressCard"; // ✅ added
  ...
  const CARDS = [
    {
      ...
      icon: <Image alt="GitHub Logo" src="/figma.svg" width={36} height={36} />,
    },
    {
      ...
      <div className="relative flex w-full max-w-5xl flex-col items-center justify-center gap-12">
        ...
        <div className="relative flex w-full flex-col items-start gap-6 self-stretch">
          <div className="grid w-full grid-cols-1 gap-6 md:grid-cols-2">
            {CARDS.map((card) => {
              const isRunCard = card.title === "Run Benchpress";
              ...
              return (
                <Wrapper
                  key={card.title}
                  {...(isLink && { href: card.url, target: "_blank" })}
                ...
                >
                  <div className="flex items-center gap-6 p-4">
                    <div className="flex flex-1 items-center gap-2">
                      ...
                      <div className="flex flex-1 flex-col items-start justify-center gap-1.5 border-l border-gray-200 pl-3.5 dark:border-gray-700">
                        ...
                        <div className="w-full font-sans text-sm text-gray-500 dark:text-gray-400">
                          {card.description}
                        </div>
                      </div>
                    </div>
                  ...
                  {/* ✅ Custom component only for Run Benchpress */}
                  {isRunCard && <RunBenchpressCard />}
                </Wrapper>
              );
            })}
          </div>
